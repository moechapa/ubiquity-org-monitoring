# Implementation | After Trigger | Plan Provisions Accepted Alert
...
Send_Email_when_Provisions_Accepted("📧 <em></em><br/>Send Email when Provisions Accepted"):::actionCalls
...
|:-- |:-- |:--:|:--: |
|1|Provisions_Accepted__c| Equal To|✅|
