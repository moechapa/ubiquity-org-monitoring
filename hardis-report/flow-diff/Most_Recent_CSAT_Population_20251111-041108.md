# Survey | Most Recent Survey Score Population (Edit)

## Flow Diagram [(_View History_)](Most_Recent_CSAT_Population-history.md)
...
click START "#general-information" "200430216"
...
click myRule_1_pmetdec "#myrule_1_pmetdec" "1582640313"

myRule_3_pmetdec{"🔀 <em></em><br/>Previously Met Decision"}:::decisions
click myRule_3_pmetdec "#myrule_3_pmetdec" "2226708163"

myRule_5_pmetdec{"🔀 <em></em><br/>Previously Met Decision"}:::decisions
click myRule_5_pmetdec "#myrule_5_pmetdec" "3496798785"
...
click myRule_1_A2 "#myrule_1_a2" "2376649899"
...
click myRule_3_A2 "#myrule_3_a2" "3408546413"

myRule_5_A1[("🛠️ <em></em><br/>Saver NPS")]:::recordUpdates
click myRule_5_A1 "#myrule_5_a1" "70466515"

myRule_5_A2[("🛠️ <em></em><br/>Date Saver NPS")]:::recordUpdates
click myRule_5_A2 "#myrule_5_a2" "2870323931"

myRule_8_A1[("🛠️ <em></em><br/>C/T NPS")]:::recordUpdates
click myRule_8_A1 "#myrule_8_a1" "3773099648"
...
myRule_5_pmetdec --> |"Previously Met - Prev"| myDecision7
...
|Label|Survey | Most Recent Survey Score Population (Edit)|
|Status|Obsolete|
|Description|Used to Populate most recent Survey Score Score on Plan|
|Interview Label|Most_Recent_CSAT_Population-8_InterviewLabel|
...
|:-- |:--:|:-- |:--  |
|formula_6_myRule_5_A1_8302248583|Number|VALUE(TEXT({!myVariable_current.NPS__c} ))|<!-- -->|
|formula_9_myRule_8_A1_1745214934|Number|VALUE(TEXT({!myVariable_current.NPS__c} ))|<!-- -->|
...
|Field|Value|
|:-- |:--: |
|Most_Recent_NPS_Score_Saver__c|formula_6_myRule_5_A1_8302248583|
...
|Field|Value|
|:-- |:--: |
|Most_Recent_NPS_Score_Sponsor_Trustee__c|formula_9_myRule_8_A1_1745214934|
