# Messaging | Route | Route to Login Help Bot

## Flow Diagram [(_View History_)](Route_to_UBQT_PW-history.md)
...
click START "#general-information" "3596341622"

RoutingAction("⚡ <em></em><br/>Route to UBQT PW"):::actionCalls
click RoutingAction "#routingaction" "3247818265"
...
|Label|Messaging | Route | Route to Login Help Bot|
|Status|Obsolete|
|Environments|Default|
|Interview Label|Route to UBQT PW  {!$Flow.CurrentDateTime}|
...
|Bot Id (input)|0XxHo000000PWlmKAG|
|Bot Label (input)|UBQT PW|
