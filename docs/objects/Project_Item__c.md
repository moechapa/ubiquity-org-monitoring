...
| :-------- | :---- | :--: | :---------- | 
| Complex_Project__c | Complex Project | MasterDetail | undefined |
...
| Project_Item_Assignments__c | [Project_Item_Set_Commitment_When_Assigned](../flows/Project_Item_Set_Commitment_When_Assigned.md) [🕒](../flows/Project_Item_Set_Commitment_When_Assigned-history.md) |  Workflow | When Item is assigned, default status of that item. |
| Project_Item__c | [Project_Item_Confirm_Item_Assignment](../flows/Project_Item_Confirm_Item_Assignment.md) [🕒](../flows/Project_Item_Confirm_Item_Assignment-history.md) |  Workflow | Validates Complex Project Items and Confirms Assignment to Team Members |
