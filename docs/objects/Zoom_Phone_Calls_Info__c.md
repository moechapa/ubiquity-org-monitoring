...
| Callee_Number_Source__c | Callee Number Source | Text | Indicates where the phone number comes from:<br/>internal — ZP native.<br/>external — BYOC or Provider Exchange.<br/>byop — Premise peering. |
| caller_name__c | Caller Name | Text | undefined |
| caller_number__c | Caller Number | Phone | undefined |
| Caller_Number_Source__c | Caller Number Source | Text | Indicates where the phone number comes from:<br/><br/>internal — ZP native.<br/>external — BYOC or Provider Exchange.<br/>byop — Premise peering. |
...
| :----  | :-------- | :--: | :---------- | 
| Zoom_Phone_Calls_Info__c | [Zoom_Calls_Trigger_After_Insert](../flows/Zoom_Calls_Trigger_After_Insert.md) [🕒](../flows/Zoom_Calls_Trigger_After_Insert-history.md) |  Record After Save | This flow will populate recording link from the related Session History Object. |
