...
Forecast_Plan__c -->|Forecast_Channel__c| Forecast_Channel__c
...
linkStyle 1,2,3,4,5 stroke:#A6A6A6,stroke-width:2px;
...
| :-------- | :---- | :--: | :---------- | 
| Actual_Plans__c | Actual Plans | Summary | undefined |
| Actual_Revenue__c | Actual Revenue | Summary | undefined |
...
| Forecast_Channel__c | Forecast Channel | Lookup | Channel being forecast. |
| Forecast_End_Date__c | Forecast End Date | Date | End date of forecast. |
| Forecast_Notes__c | Forecast Notes | LongTextArea | Used for notes on this planned forecast |
| Forecast_Start_Date__c | Forecast Start Date | Date | Start date for forecast. |
| Forecast_Type__c | Forecast Type | Picklist | Budgeted forecasts will be used by Finance to build the corresponding time period's budget. Pilot forecasts are used for new unproven partners to test capabilities and determine true volumes and capacity. |
| Forecasted_Leads__c | Forecasted Leads | Summary | # of leads forecast for this plan |
| Forecasted_Plans__c | Forecasted Plans | Summary | # of plans forecasted for this plan. |
| Forecasted_Revenue__c | Forecasted Revenue | Summary | Rollup of Forecasted Revenue from attached forecasts |
| Partner__c | Partner | Lookup | Partner for which this forecast is being planned. |
| Product__c | Product | Picklist | What products will be sold as part of this forecast? |
| Status__c | Status | Picklist | Forecast must begin in approved status. |
