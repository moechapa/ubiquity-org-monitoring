...
Product_Subscription__c -->|Product__c| Product2
Product_Subscription__c -->|Price_Book__c| Pricebook2
...
linkStyle 6,8 stroke:#4C9F70,stroke-width:4px;
linkStyle 0,1,2,3,4,5,7,9,10,11 stroke:#A6A6A6,stroke-width:2px;
...
| :-------- | :---- | :--: | :---------- | 
| Account__c | Account | Lookup | Account Subscription is associated with. |
| Cost__c | Cost | Currency | undefined |
| Effective_Date__c | Effective Date | Date | Date Subscription became effective |
| Invoice__c | Invoice | Lookup | Invoices |
| Next_Payment_Date__c | Next Payment Date | Date | Date Subscription payment will next be invoiced |
| Period__c | Period | Picklist | Period of subscription. How often will this subscription be invoiced |
| Plan__c | Plan | Lookup | Plan that the Subscription is related to |
| Price_Book__c | Price Book | Lookup | undefined |
| Product__c | Product | Lookup | undefined |
| Product_Fee_Type__c | Product Fee Type | Picklist | What fee structure does this product have? |
| Status__c | Status | Picklist | Status of Subscription |
