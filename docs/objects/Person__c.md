...
```mermaid
graph TD
Person__c["Person"]:::mainObject
click Person__c "/objects/Person__c/"
Monthly_Metrics__c["Monthly Metrics"]:::customObject
...
| 💻 | [Move_Queue_to_Person](../flows/Move_Queue_to_Person.md) [🕒](../flows/Move_Queue_to_Person-history.md) |  Auto Launched Flow | <!-- --> |
