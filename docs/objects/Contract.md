...
| Bounty__c | Bounty | Picklist | Does the partner get paid a bounty on referrals? |
| CompanySignedDate |  |  | undefined |
| CompanySignedId |  | Lookup | undefined |
| ContractTerm |  |  | undefined |
| Cost__c | Cost | Currency | undefined |
| Current_Revenue_Share__c | Current Revenue Share % | Picklist | What is the current Revenue percentage being paid to partner? |
| CustomerSignedDate |  |  | undefined |
| CustomerSignedId |  | Lookup | undefined |
| CustomerSignedTitle |  |  | undefined |
| Description |  |  | undefined |
| EndDate |  |  | undefined |
| Integration_Type__c | Integration Type | Picklist | How partner integrates with Ubiquity |
| Lead_Submission_Process__c | Lead Submission Process | LongTextArea | Please Outline the lead submission processes that have been established with the partner (Custom Form, email, phone, etc). |
| Lead_Type__c | Lead Type | Picklist | Is the partner going through a trusted qualification process before sending Ubiquity leads, or will they be routed to the SDR Team for Qualification. |
| Name |  |  | undefined |
| OwnerExpirationNotice |  |  | undefined |
| OwnerId |  | Lookup | undefined |
| Partnered_Preferred_Fund_List__c | Partnered Preferred Fund List | TextArea | Does the partner have a preferred Fund List they would like their referrals to use? |
| Payment_Schedule__c | Payment Schedule | Picklist | How often partner is paid Revenue Share |
| Renewal_Type__c | Renewal Type | Picklist | undefined |
| Revenue_Share_Notes__c | Revenue Share Notes | LongTextArea | Outline the extent of the revenue share. |
