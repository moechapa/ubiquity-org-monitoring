...
```mermaid
graph TD
Partner_Advisors__mdt["Partner Advisors"]:::mainObject
click Partner_Advisors__mdt "/objects/Partner_Advisors__mdt/"
...
| :-------- | :---- | :--: | :---------- | 
| Advisor_Service__c | Advisor Service | Picklist | undefined |
| Advisor_Type__c | Advisor Type | Picklist | undefined |
| Commission_Percentage__c | Commission Percentage | Number | undefined |
| CRD__c | CRD | Text | undefined |
...
| isPrimary__c | isPrimary | Checkbox | undefined |
| Last_Name__c | Last Name | Text | undefined |
| NPN__c | NPN | Text | undefined |
| Require_Review__c | Require Review | Checkbox | undefined |
| Roles__c | Roles | Picklist | undefined |
