...
Plan_Assets__c["Plan Assets"]:::mainObject
...
| :-------- | :---- | :--: | :---------- | 
| Balance_Date__c | Balance Date | Date | Balance Date |
| Plan__c | Plan | MasterDetail | Plan |
| Plan_Assets__c | Plan Assets | Currency | Plan Assets |
| Plan_Billable_Headcount__c | Plan Billable Headcount | Number | Count of all plan's employees with over $100. Updated during BI Monthly Upload from Global Participants w/ Balance report. |
...
| [Plan_Assets_Record_Page](../pages/Plan_Assets_Record_Page.md) |  Record Page |
