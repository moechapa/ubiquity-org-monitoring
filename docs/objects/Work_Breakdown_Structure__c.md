...
```mermaid
graph TD
Work_Breakdown_Structure__c["Work Breakdown Structure"]:::mainObject
...
| Active_Case_Deliverables__c | Active Case Deliverables | Summary | undefined |
| Case_Record_Type__c | Case Record Type Managed | Picklist | undefined |
...
| Global_Default__c | Global Default | Checkbox | undefined |
| Object_Managed__c | Object Managed | Picklist | undefined |
| Plan_Type__c | Plan Type | Picklist | undefined |
| Service_Option__c | Service Option | Picklist | undefined |
| Transition_Type__c | Transition Type | Picklist | undefined |

## Validation Rules

| Rule      | Active | Description | Formula |
| :-------- | :---- | :---------- | :------ |
| Active_Case_WBS_Active_PD_Check | Yes |  | Active_Case_Deliverables__c < 1<br/>&&<br/> Active__c = TRUE<br/>&&<br/>CONTAINS( RecordTypeId ,  "0121G000000bqxe") |
...
| Lightning Page | Type |
| :----      | :--: | 
| [WBS_Layout](../pages/WBS_Layout.md) |  Record Page |
