...
```mermaid
graph TD
Forecast_Channel__c["Forecast Channel"]:::mainObject
...
| :-------- | :---- | :--: | :---------- | 
| Channel_Notes__c | Channel Notes | LongTextArea | Notes on channel |
| Description__c | Description | LongTextArea | Description of Channel and definition. |
| Lead_Source__c | Lead Source | MultiselectPicklist | Lead Sources that roll up to Forecast Channel |
| Lead_Source_Detail__c | Lead Source Detail | MultiselectPicklist | Lead Source Details for Partner Referrals |
| Partner_Referral_Source__c | Partner Referral Source | Checkbox | True if Lead Source Includes Partner Referral |
| Rules__c | Rules | LongTextArea | Are there any rules to note for this Channel? |
| Status__c | Status | Picklist | Is this channel active or inactive for forecasting? |
