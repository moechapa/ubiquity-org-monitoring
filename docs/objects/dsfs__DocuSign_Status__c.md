...
| :-------- | :---- | :--: | :---------- | 
| Billing_Approved__c | Billing Approved | Checkbox | undefined |
| Billing_Rejected__c | Billing Rejected | Checkbox | undefined |
| FPS_Saved__c | FPS Saved | Checkbox | Confirms FPS Trust Agree was downloaded/saved |
| Implementation__c | Implementation | Lookup | Implementation related to docusign documents. |
| Opportunity_Owner__c | Opportunity Owner | Lookup | undefined |
| Plan__c | Plan | Text | Plan the Case is Linked To if the DocuSign was sent from a Case |
...
| Lightning Page | Type |
| :----      | :--: | 
| [DocuSign_Status_Record_Page](../pages/DocuSign_Status_Record_Page.md) |  Record Page |
