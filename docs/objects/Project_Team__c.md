...
linkStyle 0,2,3 stroke:#4C9F70,stroke-width:4px;
linkStyle 1,4,5,6,7 stroke:#A6A6A6,stroke-width:2px;
...
| Related_User__c | Related User | Lookup | undefined |
| Role__c | Role | MultiselectPicklist | undefined |
| Team_Member__c | Team Member | MasterDetail | undefined |

## Validation Rules

| Rule      | Active | Description | Formula |
| :-------- | :---- | :---------- | :------ |
| User_Required_to_add_Team_Member | Yes |  | Team_Member__r.RecordType.Name  = 'Ubiquity Employee'<br/>&&<br/>Related_User__c = '' |
