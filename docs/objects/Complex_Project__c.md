...
| :-------- | :---- | :--: | :---------- | 
| Analysis_Notes__c | Analysis Notes | LongTextArea | undefined |
| Description__c | Description | LongTextArea | undefined |
| Design_Notes__c | Design Notes | LongTextArea | undefined |
| Development_Notes__c | Development Notes | LongTextArea | undefined |
| Discovery_Notes__c | Discovery Notes | LongTextArea | undefined |
| Expected_Delivery_Date__c | Expected Delivery Date | Date | undefined |
| Follow_Up_Project_Required__c | Follow Up Project Required? | Picklist | undefined |
| Phase__c | Phase | Picklist | undefined |
| Previous_Complex_Project__c | Previous Complex Project | Lookup | undefined |
| Project_Items_Confirmed__c | Project Items Confirmed | Checkbox | undefined |
| QA_Testing_Notes__c | QA Testing Notes | LongTextArea | undefined |
| SOP_Required__c | SOP Required? | Picklist | undefined |

## Validation Rules

| Rule      | Active | Description | Formula |
| :-------- | :---- | :---------- | :------ |
| Confirm_Project_Items | Yes |  | ISPICKVAL(Phase__c, "Development")<br/>&&<br/> Project_Items_Confirmed__c = false |
| Confirm_SOP | Yes |  | ISPICKVAL(Phase__c, "Development")<br/>&&<br/>ISPICKVAL(SOP_Required__c, "" ) |
...
| :----  | :-------- | :--: | :---------- | 
| 💻 | [Project_Items_Confirm_Project_Items](../flows/Project_Items_Confirm_Project_Items.md) [🕒](../flows/Project_Items_Confirm_Project_Items-history.md) |  Auto Launched Flow | <!-- --> |
