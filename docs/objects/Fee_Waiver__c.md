...
```mermaid
graph TD
Fee_Waiver__c["Fee Waiver"]:::mainObject
...
linkStyle 0,2,3,4,5 stroke:#A6A6A6,stroke-width:2px;
...
| Amount__c | Amount | Currency | Amount waived |
| Case__c | Case | Lookup | undefined |
| Date__c | Date | Date | undefined |
| Department_Responsible__c | Department Responsible | Picklist | undefined |
| Fee_Waiver_Status__c | Fee Waiver Status | Picklist | undefined |
| Notes__c | Notes | LongTextArea | undefined |
| Reason_for_Fee_Waiver__c | Reason for Fee Waiver | Picklist | undefined |
| Refund_Type__c | Refund Type | Picklist | undefined |
