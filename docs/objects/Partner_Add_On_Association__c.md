...
```mermaid
graph TD
Partner_Add_On_Association__c["Partner Add-On Association"]:::mainObject
...
linkStyle 2,3,4 stroke:#A6A6A6,stroke-width:2px;
...
| :-------- | :---- | :--: | :---------- | 
| Add_On_Product__c | Add-On Product | MasterDetail | Add-On Product the Associated Partner is related to |
| Partner_Account__c | Partner Account | MasterDetail | Partner Account associated with the Add-On Product |
| Partner_Role__c | Partner Role | Picklist | undefined |
