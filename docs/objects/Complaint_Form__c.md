...
| Case_Notes__c | Case Notes | LongTextArea | Notes from the related case. |
| Case_Opened_Date_Time__c | Case Opened Date/Time | DateTime | undefined |
| Case_Owner__c | Case Owner | Lookup | Owner of the case that started the complaint |
| Case_Status__c | Case Status | Text | undefined |
| Complaint_Notes__c | Complaint Notes | LongTextArea | undefined |
| Complaint_Tier__c | Complaint Tier | Picklist | Severity of the complaint. 1 is most severe, 4 is least severe. |
| Complaint_Type__c | Complaint Type | Picklist | What is the main issue of the complaint? |
| Date_Resolved__c | Date Resolved | Date | Date the complaint was resolved |
| Manager__c | Manager | Lookup | undefined |
| Manager_Reviewed__c | Manager Reviewed | Checkbox | Checkbox to see if a manager has reviewed the complaint. |
| Resolution_Notes__c | Resolution Notes | LongTextArea | undefined |
| Resolved__c | Resolved? | Checkbox | Is the complaint resolved? |
