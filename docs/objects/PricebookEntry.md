...
| IsActive |  |  | undefined |
| Partner_Fee__c | Partner Fee | Currency | Overrides price book's partner fee |
| Partner_Fee_Override__c | Partner Fee Override | Checkbox | Indicates that the pricebook's partner fee is being overridden |
| Price_Difference_Message__c | Price Difference Message | Text | Used for quotes/invoices |
