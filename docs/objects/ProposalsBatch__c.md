...
```mermaid
graph TD
ProposalsBatch__c["ProposalsBatch"]:::mainObject
...
| :-------- | :---- | :--: | :---------- | 
| Callout_Failed__c | Callout Failed | Checkbox | Used for determining which records failed during the callout. |
| Failed_Message__c | Failed Message | LongTextArea | undefined |
| Failed_Reason__c | Failed Reason | LongTextArea | undefined |
| Proposal__c | Proposal | Lookup | undefined |
| proposalId__c | proposalId | Text | undefined |
