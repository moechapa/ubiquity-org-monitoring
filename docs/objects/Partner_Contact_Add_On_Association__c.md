...
```mermaid
graph TD
Partner_Contact_Add_On_Association__c["Partner Contact Add-On Association"]:::mainObject
...
| :-------- | :---- | :--: | :---------- | 
| Add_On_Product__c | Add-On Product | MasterDetail | Add-On Product |
| Partner_Contact__c | Partner Contact | MasterDetail | Partner Contact |
