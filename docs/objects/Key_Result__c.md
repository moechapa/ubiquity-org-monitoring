...
| :-------- | :---- | :--: | :---------- | 
| Completion_Date__c | Completion Date | Date | Completion Date of Key Result |
| Completion_Percent__c | Completion Percent | Percent | What percent of complete is this Key Result? |
| Notes__c | Notes | LongTextArea | Notes on Key Result. |
| Objective__c | Objective | MasterDetail | Objective that this KR impacts. |
| Result_Owner__c | Result Owner | Lookup | Ubiquity Employee responsible for Key Result. |
| Start_Date__c | Start Date | Date | Start Date of Key Result |
