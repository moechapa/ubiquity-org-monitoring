...
| dfsle__Rule__c | Rule | LongTextArea | JSON mapping for storing Document Generation rule helpful in implementing Conditional Template<br/>        generation. |
| FileExtension |  |  | undefined |
| FileType |  |  | undefined |
| IsAssetEnabled |  |  | undefined |
| Language |  |  | undefined |
| LEXMAGICMOVER__LegacyNoteConvertedDate__c | LegacyNoteConvertedDate | Date | The created Date of the Legacy Note Converted |
| LEXMAGICMOVER__LegacyNoteConvertedId__c | LegacyNoteConvertedId | Text | undefined |
| LEXMAGICMOVER__LegacyNoteConvertedLastModifiedDate__c | LegacyNoteConvertedLastModifiedDate | Date | undefined |
| LEXMAGICMOVER__LegacyNoteConvertedLastModifiedDateTime__c | LegacyNoteConvertedLastModifiedDateTime | DateTime | undefined |
| LEXMAGICMOVER__LegacyNoteConvertedOwnerId__c | LegacyNoteConvertedOwnerId | Text | undefined |
| LEXMAGICMOVER__LegacyNoteConvertedParentId__c | LegacyNoteConvertedParentId | Text | undefined |
