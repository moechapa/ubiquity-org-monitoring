...
| :-------- | :---- | :--: | :---------- | 
| Affected_Deliverable__c | Affected Deliverable | Lookup | undefined |
| Finish_before_Activation__c | Finish before Activation | Lookup | undefined |
| Finish_Before_Completion__c | Finish Before Completion | Lookup | undefined |
| Group_Name__c | Group Name | Text | undefined |
| Non_Linear_Progression_Trigger__c | Non-Linear Progression Trigger | Lookup | undefined |
| Not_Needed_Declined_at_Creation__c | Not Needed/Declined at Creation | Checkbox | undefined |
| Work_Breakdown_Structure__c | Work Breakdown Structure | Lookup | undefined |
