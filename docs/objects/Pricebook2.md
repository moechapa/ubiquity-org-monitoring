...
| Lead_Source_Details__c | Lead Source Details | MultiselectPicklist | 3rd priority, opportunities with these lead source details will default to this price book if there is no partner specific price book |
| Lead_Sources__c | Lead Sources | MultiselectPicklist | undefined |
| Name |  |  | undefined |
| Partner_Fee__c | Partner Fee | Currency | undefined |
