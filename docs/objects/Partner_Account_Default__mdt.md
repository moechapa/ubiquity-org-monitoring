...
```mermaid
graph TD
Partner_Account_Default__mdt["Partner Account Default"]:::mainObject
click Partner_Account_Default__mdt "/objects/Partner_Account_Default__mdt/"
...
| :-------- | :---- | :--: | :---------- | 
| Account_Name_Match__c | Account Name Match | Text | Leads converted with this company/account name will match against this field |
| Default_Master_Account_Name__c | Default Master Account Name | Text | Name of master account to search for |
| IsActive__c | Active | Checkbox | undefined |
| New_Account_Name__c | New Account Name | Text | Changes account name displayed before "-" |
