...
| Confirmed_Review__c | Confirmed Review | Picklist | I affirm I have the reviewed the document(s) referenced herein and have either: (a) noted no exception with Ubiquity’s existing procedures and operations or, (b) have noted one or more exception(s) |
...
| :----  | :-------- | :--: | :---------- | 
| 💻 | [Vendor_Review_Button_Confirm_Review](../flows/Vendor_Review_Button_Confirm_Review.md) [🕒](../flows/Vendor_Review_Button_Confirm_Review-history.md) |  Screen Flow | <!-- --> |
| Vendor_Review__c | [Vendor_Review_Before_Trigger_Update_Name](../flows/Vendor_Review_Before_Trigger_Update_Name.md) [🕒](../flows/Vendor_Review_Before_Trigger_Update_Name-history.md) |  Record Before Save | Updates the name of the VR record to "Account Name - Vendor Tier - Year of CreatedDate" |
