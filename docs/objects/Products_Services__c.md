...
```mermaid
graph TD
Products_Services__c["Products & Services"]:::mainObject
...
| Average_Annual_Cost__c | Average Annual Cost | Currency | Average annual cost of the product. If it is for 401(k) product use 15 employees for baseline. |
| Notes__c | Notes | LongTextArea | Notes on product or service |
| Opportunity_Type__c | Opportunity Type | Picklist | Type of payroll integration opportunity to create, used to route to correct opp owner. |
| Status__c | Status | Picklist | Where in the lifecycle is this product? |
