...
# ZoomUsersPhoneEntity Class

## Class Diagram

```mermaid
graph TD
  ZoomUsersPhoneEntity["ZoomUsersPhoneEntity"]:::mainApexClass
  click ZoomUsersPhoneEntity "/objects/ZoomUsersPhoneEntity/"
...
#### Return Type
**[ZoomUsersPhoneEntity](ZoomUsersPhoneEntity.md)**
