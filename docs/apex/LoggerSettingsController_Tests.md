...
graph LR
  ...
  LoggerSettingsController --> LogManagementDataSelector
  LoggerSettingsController --> Logger
  LoggerSettingsController --> LoggerDataStore
  LoggerSettingsController --> LoggerEngineDataSelector
  ...
  LogManagementDataSelector --> LoggerCache
