...
# ZoomUsersPhoneInfosBatchHttpCalloutMock Class
...
```mermaid
graph TD
  ZoomUsersPhoneInfosBatchHttpCalloutMock["ZoomUsersPhoneInfosBatchHttpCalloutMock"]:::mainApexClass
  click ZoomUsersPhoneInfosBatchHttpCalloutMock "/objects/ZoomUsersPhoneInfosBatchHttpCalloutMock/"
