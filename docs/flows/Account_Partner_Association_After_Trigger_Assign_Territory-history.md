# Account_Partner_Association_After_Trigger_Assign_Territory history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Account_Partner_Association_After_Trigger_Assign_Territory-history.md)
    ...
    click START "#general-information" "2942171197"
    ...
    click Major_Partner_Associated "#major_partner_associated" "3507241792"
    ...
    click Get_Contacts "#get_contacts" "1732274616"
    ...
    START -->  Major_Partner_Associated
    ...
    |Label|Account Partner Association | After Trigger | Assign Territory|
    |Status|Active|
    |Interview Label|Account Partner Association | After Trigger | Assign Territory {!$Flow.CurrentDateTime}|
    | Builder Type (PM)|LightningFlowBuilder|
    | Canvas Mode (PM)|FREE_FORM_CANVAS|
    | Origin Builder Type (PM)|LightningFlowBuilder|
    |Connector|[Major_Partner_Associated](#major_partner_associated)|
    |Next Node|[Major_Partner_Associated](#major_partner_associated)|
    ...
    |Condition Id|Left Value Reference|Operator|Right Value|
    |:-- |:-- |:--:|:--: |
    |1|$Record.Partner_Competitor__r.Name| Contains|Schwab|
    ...
    |Condition Id|Left Value Reference|Operator|Right Value|
    |:-- |:-- |:--:|:--: |
    |1|$Record.Partner_Competitor__r.Name| Contains|JP|
    |2|$Record.Partner_Competitor__r.Name| Equal To|Principal|
    ...
    |:-- |:-- |:--:|:--: |
    |1|AccountId| Equal To|$Record.Partner__c|
