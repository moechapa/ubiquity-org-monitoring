# Implementation_After_Update_Creation_Point_Project_Tasks history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Implementation_After_Update_Creation_Point_Project_Tasks-history.md)
    ...
    click START "#general-information" "1279059074"
    ...
    click Assign_to_Task "#assign_to_task" "1522812793"
    
    Assign_to_Task_Current_Record_Owner_0[\"🟰 <em></em><br/>Assign to Task (Current Record Owner)"/]:::assignments
    click Assign_to_Task_Current_Record_Owner_0 "#assign_to_task_current_record_owner_0" "3091122163"
    
    Assign_to_Task_Current_Record_Owner_0_0[\"🟰 <em></em><br/>Assign to Task (Current Record Owner)"/]:::assignments
    click Assign_to_Task_Current_Record_Owner_0_0 "#assign_to_task_current_record_owner_0_0" "3781686606"
    
    Kotapay_Client_Signed_Creation_Point[\"🟰 <em></em><br/>Kotapay Client Signed Creation Point"/]:::assignments
    click Kotapay_Client_Signed_Creation_Point "#kotapay_client_signed_creation_point" "3958007405"
    ...
    Creation_Point_Mapping{"🔀 <em></em><br/>Creation Point Mapping"}:::decisions
    click Creation_Point_Mapping "#creation_point_mapping" "3532070818"
    ...
    click WBS_Exists "#wbs_exists" "3278887434"
    ...
    click Delete_Existing_Tasks_0 "#delete_existing_tasks_0" "3217040954"
    
    Get_AOP_WBS[("🔍 <em></em><br/>Get AOP WBS")]:::recordLookups
    click Get_AOP_WBS "#get_aop_wbs" "1913695392"
    
    Get_Existing_Tasks_0[("🔍 <em></em><br/>Get Existing Tasks")]:::recordLookups
    click Get_Existing_Tasks_0 "#get_existing_tasks_0" "3742410522"
    
    Get_Project_Deliverables[("🔍 <em></em><br/>Get Project Deliverables")]:::recordLookups
    click Get_Project_Deliverables "#get_project_deliverables" "4164207855"
    ...
    Kotapay_Client_Signed_Creation_Point --> Get_AOP_WBS
    ...
    Creation_Point_Mapping --> |"Kotapay Client Signed"| Kotapay_Client_Signed_Creation_Point
    Creation_Point_Mapping --> |"Default Outcome"| END_Creation_Point_Mapping
    ...
    START -->  Creation_Point_Mapping
    END_Creation_Point_Mapping(( END )):::endClass
    ...
    |Label|Implementation | After Update | Creation Point Project Tasks|
    |Status|Obsolete|
    |Does Require Record Changed To Meet Criteria|✅|
    |Description|Swapped NOW() with flow interview's current time in start date assignment|
    |Environments|Default|
    |Interview Label|Implementation | After Update | Creation Point Project Tasks {!$Flow.CurrentDateTime}|
    | Builder Type (PM)|LightningFlowBuilder|
    | Canvas Mode (PM)|FREE_FORM_CANVAS|
    | Origin Builder Type (PM)|LightningFlowBuilder|
    |Connector|[Creation_Point_Mapping](#creation_point_mapping)|
    |Next Node|[Creation_Point_Mapping](#creation_point_mapping)|
    ...
    |:-- |:-- |:--:|:--: |
    |1|Kotapay_Client_Signed__c| Is Null|<!-- -->|
    ...
    |taskLoop.Implementation__c| Assign|$Record.Id|
    ...
    ### Kotapay_Client_Signed_Creation_Point
    
    |<!-- -->|<!-- -->|
    |:---|:---|
    |Type|Assignment|
    |Label|Kotapay Client Signed Creation Point|
    ...
    |Assign To Reference|Operator|Value|
    |:-- |:--:|:--: |
    |creationPoint| Assign|Kotapay Client Signed|
    ...
    ### Creation_Point_Mapping
    
    |<!-- -->|<!-- -->|
    |:---|:---|
    |Type|Decision|
    |Label|Creation Point Mapping|
    |Default Connector Label|Default Outcome|
    
    
    #### Rule Kotapay_Client_Signed (Kotapay Client Signed)
    
    |<!-- -->|<!-- -->|
    |:---|:---|
    |Connector|[Kotapay_Client_Signed_Creation_Point](#kotapay_client_signed_creation_point)|
    |Condition Logic|and|
    ...
    |Condition Id|Left Value Reference|Operator|Right Value|
    |:-- |:-- |:--:|:--: |
    |1|$Record.Kotapay_Client_Signed__c| Is Null|⬜|
    |2|$Record__Prior.Kotapay_Client_Signed__c| Is Null|✅|
    ...
    |2|Object_Managed__c| Equal To|Implementation|
    |3|Service_Option__c| Contains|$Record.Service_Option__c|
    |4|Eligible_for_Testing__c| Equal To|$Record.Eligible_for_Testing__c|
    |5|Custodian__c| Contains|$Record.Custodian__c|
    ...
    |:-- |:-- |:--:|:--: |
    |1|Implementation__c| Equal To|$Record.Id|
    |2|Creation_Point__c| Equal To|creationPoint|
