# Transition | Process | Junction to Contact

## Flow Diagram [(_View History_)](Assign_Transition_to_Junction-history.md)
...
click START "#general-information" "3928397280"

Assign_Junction_Values[\"🟰 <em></em><br/>Assign Junction Values"/]:::assignments
click Assign_Junction_Values "#assign_junction_values" "4216307667"
...
click Get_Junction "#get_junction" "2026209651"
...
|Label|Transition | Process | Junction to Contact|
|Status|Obsolete|
|Description|Maps Transition record to any relevant Associated Contact Junction upon creation|
|Interview Label|Assign Transition to Junction {!$Flow.CurrentDateTime}|
...
|:-- |:--:|:--: |
|Junction.Transition__c| Assign|recordId|
...
- [Transition_After_Trigger_Launch_Junction_To_Contact_Partner_Flows](Transition_After_Trigger_Launch_Junction_To_Contact_Partner_Flows.md)
