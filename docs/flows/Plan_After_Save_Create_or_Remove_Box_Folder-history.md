# Plan_After_Save_Create_or_Remove_Box_Folder history
...
=== "Nov 11, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Plan_After_Save_Create_or_Remove_Box_Folder-history.md)
    ...
    click START "#general-information" "2269299022"
    ...
    click Create_Folder_for_this_account "#create_folder_for_this_account" "1272693324"
    ...
    click Move_account_folder_to_subfolder "#move_account_folder_to_subfolder" "1939782397"
    ...
    click Update_Box_Id_on_Account "#update_box_id_on_account" "4177832691"
    ...
    |Label|Plan | After Save | Create or Remove Box Folder|
    |Status|Active|
    |Description|Creates box folder for new plan creation.  Removes current box folder if an account gets a second plan at least a month after the first.|
    |Environments|Default|
    |Interview Label|Plan | After Save | Create or Remove Box Folder {!$Flow.CurrentDateTime}|
    ...
    |boxNoteFormula|String|TEXT(MONTH({!$Flow.CurrentDate})) + "/" + TEXT(DAY({!$Flow.CurrentDate})) + "/" + TEXT(YEAR({!$Flow.CurrentDate})) + " - Created client folders. Link to Box: https://ubiquity.app.box.com/folder/" + {!newBoxFolderId} + " - AUTO" +<br/>IF(ISBLANK({!$Record.Implementation__r.Implementation_Notes__c}),"",BR() + {!$Record.Implementation__r.Implementation_Notes__c})|<!-- -->|
    ...
    |Output Parameters|assignToReference: newBoxFolderId<br/>name: folderId<br/>|
    ...
    |Store Output Automatically|✅|
    |Folder Id (input)|newBoxFolderId|
    ...
    |Field|Value|
    |:-- |:--: |
    |Box_Folder_Id__c|newBoxFolderId|
