# Messaging_Route_Route_From_Bot_to_Login_Help_Queue history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Messaging_Route_Route_From_Bot_to_Login_Help_Queue-history.md)
    ...
    click START "#general-information" "1070705016"
    
    Copy_1_of_Route_Work("⚡ <em></em><br/>Copy 1 of Route Work"):::actionCalls
    click Copy_1_of_Route_Work "#copy_1_of_route_work" "1897009865"
    
    Copy_1_of_Route_Work --> END_Copy_1_of_Route_Work
    START -->  Copy_1_of_Route_Work
    ...
    |Label|Messaging | Route | Route From Bot to Login Help Queue|
    |Status|Obsolete|
    |Environments|Default|
    |Interview Label|Messaging | Route | Route From Bot to Login Help Queue {!$Flow.CurrentDateTime}|
    | Builder Type (PM)|LightningFlowBuilder|
    | Canvas Mode (PM)|AUTO_LAYOUT_CANVAS|
    | Origin Builder Type (PM)|LightningFlowBuilder|
    |Connector|[Copy_1_of_Route_Work](#copy_1_of_route_work)|
    |Next Node|[Copy_1_of_Route_Work](#copy_1_of_route_work)|
