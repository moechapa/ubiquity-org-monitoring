# Contact_Button_Create_Advisor_Sourced_Lead_Activity_FIX history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Contact_Button_Create_Advisor_Sourced_Lead_Activity_FIX-history.md)
    ...
    click START "#general-information" "2268038383"
    ...
    click Task_Variables "#task_variables" "659821143"
    
    Loop_through_Leads{{"🔁 <em></em><br/>Loop through Leads"}}:::loops
    click Loop_through_Leads "#loop_through_leads" "3203100741"
    ...
    Loop_through_Leads --> |"For Each"|Task_Variables
    ...
    |Label|Contact | Button | Create Advisor-Sourced Lead Activity FIX|
    |Status|⚠️ Draft|
    |Interview Label|Contact | Button | Create Advisor-Sourced Lead Activity FIX {!$Flow.CurrentDateTime}|
    ...
    |Iteration Order|Asc|
    |Next Value Connector|[Task_Variables](#task_variables)|
