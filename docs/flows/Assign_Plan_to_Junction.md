# Plan | Process | Junction to Contact

## Flow Diagram [(_View History_)](Assign_Plan_to_Junction-history.md)
...
click START "#general-information" "1284241044"

Assign_Junction_Values[\"🟰 <em></em><br/>Assign Junction Values"/]:::assignments
click Assign_Junction_Values "#assign_junction_values" "1060439227"

Assign_Junction_Values_0[\"🟰 <em></em><br/>Assign Junction Values"/]:::assignments
click Assign_Junction_Values_0 "#assign_junction_values_0" "1053466737"
...
click Assign_to_Collection_0 "#assign_to_collection_0" "2541208525"

Is_Opp_Null{"🔀 <em></em><br/>Is Opp Null?"}:::decisions
click Is_Opp_Null "#is_opp_null" "3951037334"
...
Is_Opp_Null --> |"Opp Present"| Get_Junction2
Is_Opp_Null --> |"Yes"| END_Is_Opp_Null
...
Get_Junction2 --> Junction_Loop_0
Get_Opp --> Is_Opp_Null
Get_Plan --> Type_of_Plan
Update_Junction --> END_Update_Junction
START -->  Get_Plan
END_Is_Opp_Null(( END )):::endClass
...
|Label|Plan | Process | Junction to Contact|
|Status|Obsolete|
|Description|Updated "is opp null" decision element for single(k) - was erroring when opp is null.<br/><br/>Maps Plan record to any relevant Associated Contact Junction upon creation|
|Environments|Default|
|Interview Label|Assign Plan to Junction {!$Flow.CurrentDateTime}|
...
|:-- |:--:|:--: |
|Junction.Plan__c| Assign|recordId|
...
|Label|Junction Loop|
|Assign Next Value To Reference|Junction|
|Collection Reference|[Get_Junction2](#get_junction2)|
|Iteration Order|Asc|
...
|Filter Id|Field|Operator|Value|
|:-- |:-- |:--:|:--: |
|1|Opportunity__c| Equal To|oppId.Id|
...
|Label|Get Opp|
|Assign Null Values If No Records Found|✅|
|Output Reference|oppId|
|Queried Fields|Id|
|Connector|[Is_Opp_Null](#is_opp_null)|
