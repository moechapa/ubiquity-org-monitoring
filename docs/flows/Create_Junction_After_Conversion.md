# Lead | Process | Create Contact Junction
...
Add_additional_AC_to_collection[\"🟰 <em></em><br/>Add additional AC to collection"/]:::assignments
click Add_additional_AC_to_collection "#add_additional_ac_to_collection" "1148785936"

Add_advisor_to_collections[\"🟰 <em></em><br/>Add advisor to collections"/]:::assignments
click Add_advisor_to_collections "#add_advisor_to_collections" "3745221489"

Add_email_to_collection[\"🟰 <em></em><br/>Add email to collection"/]:::assignments
click Add_email_to_collection "#add_email_to_collection" "1595189486"

Add_final_email[\"🟰 <em></em><br/>Add final email"/]:::assignments
click Add_final_email "#add_final_email" "862096269"

Add_referring_contact_to_collection[\"🟰 <em></em><br/>Add referring contact to collection"/]:::assignments
click Add_referring_contact_to_collection "#add_referring_contact_to_collection" "2682005373"

add_referring_partner_to_collection[\"🟰 <em></em><br/>add referring partner to collection"/]:::assignments
click add_referring_partner_to_collection "#add_referring_partner_to_collection" "3344800085"

Add_to_AC_Collection[\"🟰 <em></em><br/>Add to AC Collection"/]:::assignments
click Add_to_AC_Collection "#add_to_ac_collection" "2156478035"

Add_tpa_to_collections[\"🟰 <em></em><br/>Add tpa to collections"/]:::assignments
click Add_tpa_to_collections "#add_tpa_to_collections" "334515963"

Assign_ac_role_from_lead[\"🟰 <em></em><br/>Assign ac role from lead"/]:::assignments
click Assign_ac_role_from_lead "#assign_ac_role_from_lead" "4139744140"

Assign_additional_advisor_AC_values[\"🟰 <em></em><br/>Assign additional advisor AC values"/]:::assignments
click Assign_additional_advisor_AC_values "#assign_additional_advisor_ac_values" "1247303236"

Assign_advisor_AC_values[\"🟰 <em></em><br/>Assign advisor AC values"/]:::assignments
click Assign_advisor_AC_values "#assign_advisor_ac_values" "3395357136"

Assign_Advisor_AP_values[\"🟰 <em></em><br/>Assign Advisor AP values"/]:::assignments
click Assign_Advisor_AP_values "#assign_advisor_ap_values" "1603945769"

Assign_ap_role_from_lead[\"🟰 <em></em><br/>Assign ap role from lead"/]:::assignments
click Assign_ap_role_from_lead "#assign_ap_role_from_lead" "4016365381"

Assign_generic_ac_referrer_role[\"🟰 <em></em><br/>Assign generic ac referrer role"/]:::assignments
click Assign_generic_ac_referrer_role "#assign_generic_ac_referrer_role" "2015157750"

Assign_generic_ap_referrer_role[\"🟰 <em></em><br/>Assign generic ap referrer role"/]:::assignments
click Assign_generic_ap_referrer_role "#assign_generic_ap_referrer_role" "3986867307"

Assign_referring_contact[\"🟰 <em></em><br/>Assign referring contact"/]:::assignments
click Assign_referring_contact "#assign_referring_contact" "2672336397"

Assign_referring_partner[\"🟰 <em></em><br/>Assign referring partner"/]:::assignments
click Assign_referring_partner "#assign_referring_partner" "3650077312"

Assign_TPA_AC_values[\"🟰 <em></em><br/>Assign TPA AC values"/]:::assignments
click Assign_TPA_AC_values "#assign_tpa_ac_values" "1852186964"

Assign_TPA_AP_values[\"🟰 <em></em><br/>Assign TPA AP values"/]:::assignments
click Assign_TPA_AP_values "#assign_tpa_ap_values" "1614388975"

Connect_proposal_to_opp[\"🟰 <em></em><br/>Connect proposal to opp"/]:::assignments
click Connect_proposal_to_opp "#connect_proposal_to_opp" "1176130754"

Converted_Contact_AC[\"🟰 <em></em><br/>Converted Contact AC"/]:::assignments
click Converted_Contact_AC "#converted_contact_ac" "751478326"

Copy_1_of_Wipe_Association_values[\"🟰 <em></em><br/>Copy 1 of Wipe Association values"/]:::assignments
click Copy_1_of_Wipe_Association_values "#copy_1_of_wipe_association_values" "3970955329"

LSD_ADV[\"🟰 <em></em><br/>LSD = ADV"/]:::assignments
click LSD_ADV "#lsd_adv" "2131760330"

LSD_DIR[\"🟰 <em></em><br/>LSD = DIR"/]:::assignments
click LSD_DIR "#lsd_dir" "394018171"

LSD_TPA[\"🟰 <em></em><br/>LSD = TPA"/]:::assignments
click LSD_TPA "#lsd_tpa" "2333720829"

LSD_Value_on_Proposal[\"🟰 <em></em><br/>LSD = Value on Proposal"/]:::assignments
click LSD_Value_on_Proposal "#lsd_value_on_proposal" "100877747"

Raise_advisor_contact_dupe_flag[\"🟰 <em></em><br/>Raise advisor contact dupe flag"/]:::assignments
click Raise_advisor_contact_dupe_flag "#raise_advisor_contact_dupe_flag" "491512326"

Raise_advisor_partner_dupe_flag[\"🟰 <em></em><br/>Raise advisor partner dupe flag"/]:::assignments
click Raise_advisor_partner_dupe_flag "#raise_advisor_partner_dupe_flag" "1491162132"

Raise_contact_and_partner_dupe_flags[\"🟰 <em></em><br/>Raise contact and partner dupe flags"/]:::assignments
click Raise_contact_and_partner_dupe_flags "#raise_contact_and_partner_dupe_flags" "3414547119"

Raise_tpa_contact_and_partner_dupe_flags[\"🟰 <em></em><br/>Raise tpa contact and partner dupe flags"/]:::assignments
click Raise_tpa_contact_and_partner_dupe_flags "#raise_tpa_contact_and_partner_dupe_flags" "1142299567"

raise_tpa_contact_dupe_flag[\"🟰 <em></em><br/>raise tpa contact dupe flag"/]:::assignments
click raise_tpa_contact_dupe_flag "#raise_tpa_contact_dupe_flag" "2168901531"

raise_tpa_partner_dupe_flag[\"🟰 <em></em><br/>raise tpa partner dupe flag"/]:::assignments
click raise_tpa_partner_dupe_flag "#raise_tpa_partner_dupe_flag" "1877374688"

Remove_Leftmost_Email[\"🟰 <em></em><br/>Remove Leftmost Email"/]:::assignments
click Remove_Leftmost_Email "#remove_leftmost_email" "300723731"

Wipe_AC_Values[\"🟰 <em></em><br/>Wipe AC Values"/]:::assignments
click Wipe_AC_Values "#wipe_ac_values" "26944214"

Wipe_Association_values[\"🟰 <em></em><br/>Wipe Association values"/]:::assignments
click Wipe_Association_values "#wipe_association_values" "3536140433"

Additional_contacts_found_check{"🔀 <em></em><br/>Additional contacts found check"}:::decisions
click Additional_contacts_found_check "#additional_contacts_found_check" "1846516542"

Additional_FP_email_parse{"🔀 <em></em><br/>Additional FP email parse"}:::decisions
click Additional_FP_email_parse "#additional_fp_email_parse" "224960811"

Check_for_referring_contact{"🔀 <em></em><br/>Check for referring contact"}:::decisions
click Check_for_referring_contact "#check_for_referring_contact" "2851389204"

Check_for_referring_partner{"🔀 <em></em><br/>Check for referring partner"}:::decisions
click Check_for_referring_partner "#check_for_referring_partner" "403499893"

Check_if_advisor_value_s_match_lead_fields{"🔀 <em></em><br/>Check if advisor value(s) match lead fields"}:::decisions
click Check_if_advisor_value_s_match_lead_fields "#check_if_advisor_value_s_match_lead_fields" "451252991"

Check_if_tpa_value_s_match_lead_fields{"🔀 <em></em><br/>Check if tpa value(s) match lead fields"}:::decisions
click Check_if_tpa_value_s_match_lead_fields "#check_if_tpa_value_s_match_lead_fields" "1555548874"

Contact_role_check{"🔀 <em></em><br/>Contact role check"}:::decisions
...
Is_an_Opp_present{"🔀 <em></em><br/>Is an Opp present?"}:::decisions
click Is_an_Opp_present "#is_an_opp_present" "1971408506"

Is_TPA_Present{"🔀 <em></em><br/>Is TPA Present?"}:::decisions
click Is_TPA_Present "#is_tpa_present" "1130798678"

Partner_Role_Check{"🔀 <em></em><br/>Partner Role Check"}:::decisions
click Partner_Role_Check "#partner_role_check" "1419647573"

Partners_to_create_check{"🔀 <em></em><br/>Partners to create check"}:::decisions
click Partners_to_create_check "#partners_to_create_check" "125213229"

Proposal_partner_check{"🔀 <em></em><br/>Proposal partner check"}:::decisions
click Proposal_partner_check "#proposal_partner_check" "2199341691"

Proposal_Present{"🔀 <em></em><br/>Proposal Present?"}:::decisions
click Proposal_Present "#proposal_present" "49716265"

Referrer_Type_Validation{"🔀 <em></em><br/>Referrer Type Validation"}:::decisions
click Referrer_Type_Validation "#referrer_type_validation" "740089335"

Secondary_Advisor_Check{"🔀 <em></em><br/>Secondary Advisor Check"}:::decisions
click Secondary_Advisor_Check "#secondary_advisor_check" "2503529061"

Additional_Contact_Loop{{"🔁 <em></em><br/>Additional Contact Loop"}}:::loops
click Additional_Contact_Loop "#additional_contact_loop" "2033684169"

Create_Associated_Contacts[("➕ <em></em><br/>Create Associated Contacts")]:::recordCreates
click Create_Associated_Contacts "#create_associated_contacts" "3947532543"

Create_Associated_Partners[("➕ <em></em><br/>Create Associated Partners")]:::recordCreates
click Create_Associated_Partners "#create_associated_partners" "1693371479"

Find_additional_advisor_contacts[("🔍 <em></em><br/>Find additional advisor contacts")]:::recordLookups
...
Update_Opportunity_0_0_0[("🛠️ <em></em><br/>Update Opportunity")]:::recordUpdates
...
|acDupe|Boolean|⬜|⬜|⬜|<!-- -->|<!-- -->|
|additionalEmailSearchCollection|String|✅|⬜|⬜|<!-- -->|<!-- -->|
|apCollection|SObject|✅|⬜|⬜|Associated_Partner__c|<!-- -->|
|apDupe|Boolean|⬜|⬜|⬜|<!-- -->|<!-- -->|
|associatedContact|SObject|⬜|⬜|⬜|Associated_Contact__c|<!-- -->|
|associatedPartner|SObject|⬜|⬜|⬜|Associated_Partner__c|<!-- -->|
|emailFieldRaw|String|⬜|⬜|⬜|<!-- -->|Raw Additional FP email field value|
|leadInput|SObject|⬜|✅|⬜|Lead|<!-- -->|
...
|associatedPartner.Opportunity__c| Assign|leadInput.ConvertedOpportunityId|
|associatedPartner.Primary_Partner__c| Assign|✅|
...
|associatedContact.Opportunity__c| Assign|leadInput.ConvertedOpportunityId|
|associatedContact.Primary__c| Assign|✅|
...
|:-- |:-- |:--:|:--: |
|1|[Find_additional_advisor_contacts](#find_additional_advisor_contacts)| Is Empty|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|leadInput.Associated_Contact__c| Is Null|⬜|
|2|acDupe| Equal To|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|leadInput.Associated_Partner__c| Is Null|⬜|
|2|apDupe| Equal To|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|leadInput.Associated_Contact_Role__c| Is Blank|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|proposal.Advisor_Account__c| Is Null|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|leadInput.ConvertedOpportunityId| Is Null|✅|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|leadInput.Associated_Partner_Role__c| Is Blank|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|proposal.Lead_Source_Detail__c| Is Blank|⬜|
...
|Condition Id|Left Value Reference|Operator|Right Value|
|:-- |:-- |:--:|:--: |
|1|proposal.Additional_Financial_Professional_Emails__c| Is Blank|⬜|
...
- [Lead_After_Create_or_Update_Master_Flow](Lead_After_Create_or_Update_Master_Flow.md)
