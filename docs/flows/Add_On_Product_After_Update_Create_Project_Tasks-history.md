# Add_On_Product_After_Update_Create_Project_Tasks history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Add_On_Product_After_Update_Create_Project_Tasks-history.md)
    ...
    click START "#general-information" "2930289901"
    ...
    click Does_a_task_already_exist_0_0 "#does_a_task_already_exist_0_0" "2735181133"
    ...
    click Get_Existing_Tasks_0 "#get_existing_tasks_0" "3963065303"
    ...
    |Label|Add-On Product | After Update | Create Project Tasks|
    |Status|Active|
    |Description|10/7/22- Removed lookup to Opportunity|
    |Environments|Default|
    |Interview Label|Add-On Product | After Update | Create Project Tasks {!$Flow.CurrentDateTime}|
    ...
    |:-- |:-- |:--:|:--: |
    |1|Product_Status__c| Not Equal To|Terminated Integration|
    |2|Product_Status__c| Not Equal To|Cancelled Setup|
    |3|Product_Status__c| Not Equal To|Completed Setup|
    |4|Product_Status__c| Not Equal To|Stalled Setup|
    |5|Product_Status__c| Not Equal To|On Hold|
    |6|Product_Status__c| Not Equal To|Transferred to Finch|
    ...
    |:-- |:-- |:--:|:--: |
    |1|existingTask.Id| Is Null|⬜|
    |2|existingTask.Work_Breakdown_Structure__c| Contains|Add-On Product ||
