# Docusign | Autolaunched | Send Transition Docusign
...
- [Transitions_After_Trigger_Automated_Cases_and_Emails](Transitions_After_Trigger_Automated_Cases_and_Emails.md)
