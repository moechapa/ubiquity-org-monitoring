# Plan_Button_Create_Add_On_Opp history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Plan_Button_Create_Add_On_Opp-history.md)
    ...
    click START "#general-information" "1350679368"
    ...
    click Opp_Assignment "#opp_assignment" "2721978487"
    ...
    click Get_Implementation "#get_implementation" "2177377915"
    ...
    Get_Implementation --> Opp_Assignment
    ...
    |:---|:---|
    |Process Type| Flow|
    |Label|Plan | Button | Create Add-On Opp|
    |Status|⚠️ Draft|
    ...
    |oppName|String|{!Get_Implementation.Name} + " - Add-On Product"|<!-- -->|
    ...
    |Assign To Reference|Operator|Value|
    |:-- |:--:|:--: |
    |addOnOpp.OwnerId| Assign|0051G000006HUFr|
    ...
    |addOnOpp.StageName| Assign|a: New Integration Request|
