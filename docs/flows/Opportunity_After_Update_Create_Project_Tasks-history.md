# Opportunity_After_Update_Create_Project_Tasks history
...
=== "Nov 11, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Opportunity_After_Update_Create_Project_Tasks-history.md)
    ...
    click START "#general-information" "3512512041"
    
    Add_Start_Date[\"🟰 <em></em><br/>Add Start Date"/]:::assignments
    click Add_Start_Date "#add_start_date" "3872423301"
    ...
    click Assign_to_Task "#assign_to_task" "1849866019"
    
    Assign_to_Task_Current_Record_Owner_0[\"🟰 <em></em><br/>Assign to Task (Current Record Owner)"/]:::assignments
    click Assign_to_Task_Current_Record_Owner_0 "#assign_to_task_current_record_owner_0" "1908274618"
    
    Assign_to_Task_Current_Record_Owner_0_0[\"🟰 <em></em><br/>Assign to Task (Current Record Owner)"/]:::assignments
    click Assign_to_Task_Current_Record_Owner_0_0 "#assign_to_task_current_record_owner_0_0" "84221736"
    
    Intro_Values[\"🟰 <em></em><br/>Intro Values"/]:::assignments
    click Intro_Values "#intro_values" "1393462603"
    
    Remove_Start_Date[\"🟰 <em></em><br/>Remove Start Date"/]:::assignments
    click Remove_Start_Date "#remove_start_date" "1945040858"
    ...
    Intro_Task_Present{"🔀 <em></em><br/>Intro Task Present"}:::decisions
    click Intro_Task_Present "#intro_task_present" "3074425982"
    ...
    click WBS_Exists "#wbs_exists" "465966172"
    
    WBS_Exists_0{"🔀 <em></em><br/>WBS Exists?"}:::decisions
    click WBS_Exists_0 "#wbs_exists_0" "2055073197"
    ...
    click Delete_Existing_Tasks_0 "#delete_existing_tasks_0" "1836437393"
    
    Get_Existing_Tasks_0[("🔍 <em></em><br/>Get Existing Tasks")]:::recordLookups
    click Get_Existing_Tasks_0 "#get_existing_tasks_0" "1968777517"
    
    Get_Opp_WBS[("🔍 <em></em><br/>Get Opp WBS")]:::recordLookups
    click Get_Opp_WBS "#get_opp_wbs" "1861819669"
    
    Get_Opp_WBS_0[("🔍 <em></em><br/>Get Opp WBS")]:::recordLookups
    click Get_Opp_WBS_0 "#get_opp_wbs_0" "230374009"
    ...
    Add_Start_Date --> Intro_Task_Present
    ...
    Intro_Values --> Assign_to_Collection
    Remove_Start_Date --> Intro_Task_Present
    ...
    Intro_Task_Present --> |"Intro Found"| Intro_Values
    Intro_Task_Present --> |"Intro Not Found"| Assign_to_Collection
    ...
    WBS_Exists --> |"No"| Get_Opp_WBS_0
    WBS_Exists_0 --> |"Yes"| Get_Project_Deliverables
    WBS_Exists_0 --> |"No"| END_WBS_Exists_0
    ...
    Get_Opp_WBS --> WBS_Exists
    Get_Opp_WBS_0 --> WBS_Exists_0
    Get_Project_Deliverables --> Get_Existing_Tasks_0
    START -->  Get_Opp_WBS
    END_WBS_Exists_0(( END )):::endClass
    ...
    |Label|Opportunity | After Update | Create Project Tasks|
    |Status|Active|
    |Environments|Default|
    |Interview Label|Opportunity | After Update | Create Project Tasks {!$Flow.CurrentDateTime}|
    | Builder Type (PM)|LightningFlowBuilder|
    | Canvas Mode (PM)|FREE_FORM_CANVAS|
    | Origin Builder Type (PM)|LightningFlowBuilder|
    |Connector|[Get_Opp_WBS](#get_opp_wbs)|
    |Next Node|[Get_Opp_WBS](#get_opp_wbs)|
    ...
    |:-- |:-- |:--:|:--: |
    |1|Product_Type__c| Equal To|Add-On Product|
    |2|StageName| Not Equal To|Closed Won|
    |3|StageName| Not Equal To|Closed Lost|
    |4|Service_Option__c| Not Equal To|CensiblyYours_Prior338|
    |5|Service_Option__c| Not Equal To|CensiblyYours - No Prior 3(38)|
    ...
    |Connector|[Intro_Task_Present](#intro_task_present)|
    ...
    |taskLoop.Opportunity__c| Assign|$Record.Id|
    ...
    |Assign To Reference|Operator|Value|
    |:-- |:--:|:--: |
    |taskLoop.Actual_Start_Date__c| Assign|existingTask.Actual_Start_Date__c|
    |taskLoop.Actual_Completion_Date__c| Assign|existingTask.Actual_Completion_Date__c|
    |taskLoop.Status__c| Assign|existingTask.Status__c|
    |taskLoop.Team_Member__c| Assign|existingTask.Team_Member__c|
    ...
    |:---|:---|
    |Type|Decision|
    |Label|Intro Task Present|
    |Default Connector|[Assign_to_Collection](#assign_to_collection)|
    |Default Connector Label|Intro Not Found|
    
    
    #### Rule Intro_Found (Intro Found)
    
    |<!-- -->|<!-- -->|
    |:---|:---|
    |Connector|[Intro_Values](#intro_values)|
    |Condition Logic|and|
    ...
    |Condition Id|Left Value Reference|Operator|Right Value|
    |:-- |:-- |:--:|:--: |
    |1|existingTask.Work_Breakdown_Structure__c| Equal To|Opportunity | Introduction|
    |2|existingTask.Actual_Completion_Date__c| Is Null|⬜|
    ...
    |Type|Decision|
    |Label|WBS Exists?|
    |Default Connector|[Get_Opp_WBS_0](#get_opp_wbs_0)|
    |Default Connector Label|No|
    ...
    |Output Assignments|- assignToReference: existingTask.Actual_Completion_Date__c<br/>&nbsp;&nbsp;field: Actual_Completion_Date__c<br/>- assignToReference: existingTask.Actual_Start_Date__c<br/>&nbsp;&nbsp;field: Actual_Start_Date__c<br/>- assignToReference: existingTask.Id<br/>&nbsp;&nbsp;field: Id<br/>- assignToReference: existingTask.Name<br/>&nbsp;&nbsp;field: Name<br/>- assignToReference: existingTask.Status__c<br/>&nbsp;&nbsp;field: Status__c<br/>- assignToReference: existingTask.Team_Member__c<br/>&nbsp;&nbsp;field: Team_Member__c<br/>- assignToReference: existingTask.Work_Breakdown_Structure__c<br/>&nbsp;&nbsp;field: Work_Breakdown_Structure__c<br/>|
    ...
    |2|Object_Managed__c| Equal To|Opportunity|
    |3|Service_Option__c| Equal To|$Record.Service_Option__c|
    ...
    |Assign Null Values If No Records Found|✅|
    |Output Assignments|- assignToReference: wbs.Id<br/>&nbsp;&nbsp;field: Id<br/>- assignToReference: wbs.Name<br/>&nbsp;&nbsp;field: Name<br/>|
    |Connector|[WBS_Exists_0](#wbs_exists_0)|
