# Project Task | Button | Declined

## Flow Diagram [(_View History_)](Task_Declined-history.md)
...
click START "#general-information" "148923312"

Assign_Completion_Date[\"🟰 <em></em><br/>Assign Completion Date"/]:::assignments
click Assign_Completion_Date "#assign_completion_date" "751006826"
...
|Label|Project Task | Button | Declined|
|Status|Active|
|Description|Marks Project Task as "Declined"|
|Environments|Default|
|Interview Label|Task Declined {!$Flow.CurrentDateTime}|
...
|Get_Task.Status__c| Assign|Declined|
