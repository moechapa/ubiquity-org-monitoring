# DocuSign_Related_Record_Mapping history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](DocuSign_Related_Record_Mapping-history.md)
    ...
    click START "#general-information" "197359486"
    ...
    click Does_Contact_Exist "#does_contact_exist" "148436635"
    ...
    click Does_Duplicate_Exist "#does_duplicate_exist" "800560182"
    ...
    Does_Lead_Exist_0_0{"🔀 <em></em><br/>Does Lead Exist?"}:::decisions
    click Does_Lead_Exist_0_0 "#does_lead_exist_0_0" "1015797468"
    ...
    click Get_Converted_Lead "#get_converted_lead" "1156406839"
    ...
    click Get_Docusign_Recipient_Status "#get_docusign_recipient_status" "3005172439"
    ...
    click Get_Duplicate_Account "#get_duplicate_account" "3427573444"
    ...
    Get_Lead_0_0[("🔍 <em></em><br/>Get Lead")]:::recordLookups
    click Get_Lead_0_0 "#get_lead_0_0" "3269221641"
    ...
    click Get_Opportunity_Owner "#get_opportunity_owner" "1951656645"
    ...
    click Update_Account "#update_account" "2645742224"
    ...
    click Update_Collection "#update_collection" "3793668470"
    
    Update_Contact[("🛠️ <em></em><br/>Update Contact")]:::recordUpdates
    click Update_Contact "#update_contact" "1310034597"
    ...
    Does_Lead_Exist_0_0 --> |"Yes"| Is_Lead_Owned_by_User
    Does_Lead_Exist_0_0 --> |"No"| Get_Lead
    ...
    Get_Lead_0_0 --> Does_Lead_Exist_0_0
    ...
    |Label|DocuSign | Process | Map Related Records|
    |Status|Active|
    |Description|Links records related to the Document, based on recipient information.|
    |Interview Label|DocuSign Related Record Mapping {!$Flow.CurrentDateTime}|
    ...
    |Default Connector|[Get_Lead_0_0](#get_lead_0_0)|
    |Default Connector Label|No|
    ...
    |Assign Null Values If No Records Found|✅|
    |Output Assignments|- assignToReference: leadId<br/>&nbsp;&nbsp;field: Id<br/>- assignToReference: ownerId<br/>&nbsp;&nbsp;field: OwnerId<br/>|
    |Connector|[Does_Lead_Exist_0_0](#does_lead_exist_0_0)|
    ...
    |Assign Null Values If No Records Found|⬜|
    |Output Assignments|- assignToReference: OppOwner.Id<br/>&nbsp;&nbsp;field: Id<br/>- assignToReference: OppOwner.OwnerId<br/>&nbsp;&nbsp;field: OwnerId<br/>|
    ...
    |Filter Id|Field|Operator|Value|
    |:-- |:-- |:--:|:--: |
    |1|Id| Equal To|ExistingAccount.Id|
    ...
    |Field|Value|
    |:-- |:--: |
    |NumberOfEmployees|Get_Account.NumberOfEmployees|
