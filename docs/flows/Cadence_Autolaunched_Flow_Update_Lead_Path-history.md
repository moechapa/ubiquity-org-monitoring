# Cadence_Autolaunched_Flow_Update_Lead_Path history
...
=== "Nov 11, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Cadence_Autolaunched_Flow_Update_Lead_Path-history.md)
    ...
    click START "#general-information" "2100257771"
    ...
    click UpdateLeadStatus "#updateleadstatus" "1602326699"
    ...
    |Label|Cadence Autolaunched Flow: Update Lead Path|
    |Status|Active|
    |Description|Updates the lead record's Status field to Contacted.|
    |Environments|Default|
    |Interview Label|$Label.SECadenceFlow.UpdateLeadPath {!$Flow.CurrentDateTime}|
