# Purchase API | Get Purchase Link
...
- [Proposal_Button_Send_Plan_to_Paradigm](Proposal_Button_Send_Plan_to_Paradigm.md)
- [Purchase_API_Callout_Trigger](Purchase_API_Callout_Trigger.md)
