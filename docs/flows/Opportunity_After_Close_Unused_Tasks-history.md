# Opportunity_After_Close_Unused_Tasks history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Opportunity_After_Close_Unused_Tasks-history.md)
    ...
    click START "#general-information" "2378881462"
    ...
    click Update_Task_Status "#update_task_status" "2775547547"
    ...
    click Get_Project_Tasks "#get_project_tasks" "3847376757"
    ...
    |Label|Opportunity | After | Close Unused Tasks|
    |Status|Active|
    |Does Require Record Changed To Meet Criteria|✅|
    |Interview Label|Opportunity | After | Close Unused Tasks {!$Flow.CurrentDateTime}|
