# Project_Task_Process_Complete_Tasks history
...
=== "Nov 10, 2025 (Initial)"
    ...
    ## Flow Diagram [(_View History_)](Project_Task_Process_Complete_Tasks-history.md)
    ...
    click START "#general-information" "3786198233"
    ...
    click Assign_New_Values_0_0 "#assign_new_values_0_0" "2950769147"
    ...
    click Ready_or_In_Progress_Upon_Activation "#ready_or_in_progress_upon_activation" "3386335240"
    ...
    click Get_Tasks_to_Activate "#get_tasks_to_activate" "1484332566"
    ...
    click Get_Task "#get_task" "3275327103"
    ...
    Get_Tasks_to_Activate ---> |"After Last"|Are_there_tasks_to_create_or_update
    ...
    |Status|Obsolete|
    |Interview Label|Project Task | Process | Complete Tasks {!$Flow.CurrentDateTime}|
